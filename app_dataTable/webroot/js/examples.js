$(function() {
    ...
    $('#index').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/index.json",
        "sDom": 'CRTfrtip'
    });
    ...
    $('#linkable').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/linkable.json",
        "sDom": 'CRTfrtip',
        "aoColumns":[
            {bVisible: false},
            null,
    ...
    $('#containable').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/containable.json",
        "sDom": 'CRTfrtip',
        "aoColumns":[
            {bVisible: false},
            null,
    ...
    $('#concat').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/concat.json",
        "sDom": 'CRTfrtip',
        "aoColumns":[
            {bVisible: false},
            null,
    ...
    $('#virtualFields').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/virtualFields.json",
        "sDom": 'CRTfrtip',
        "aoColumns":[
            {bVisible: false},
            null,
    ...
    $('#noJsonHandler').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "/cakephp-plugins/cities/noJsonHandler",
        "sDom": 'CRTfrtip',
        "aoColumns":[
            {bVisible: false},
            null,
